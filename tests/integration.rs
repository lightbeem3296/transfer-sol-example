...
use solana_sdk::{
    signature::Keypair, signature::Signer, system_program, system_transaction,
    transaction::Transaction,
};
use solana_validator::test_validator::*;
use transfer_sol_example::TransferInstruction;
...
fn test_validator_transaction() {
    ...
    let instruction_data = to_vec(&transfer_ix).unwrap();
